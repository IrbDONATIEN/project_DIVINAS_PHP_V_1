    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h4 class="text-center text-primary mt-2">Vous pouvez voir tous les rapports des mariages pour toutes les communes!</h4>
            </div>
        </div>
            ...
            e.preventDefault();
                ...
                $.ajax({
                    ...
                    success:function(response){
                        data=JSON.parse(response);
                        console.log(data);
                        window.location = 'document_acte.php?id='+detail_mariage_id;
                    }
                });
        });
