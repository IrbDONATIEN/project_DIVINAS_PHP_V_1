    ...
    <body>
        ...
        <!-- Navbar links -->
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                ...
                <li class="nav-item">
                    <a class="nav-link <?=(basename($_SERVER['PHP_SELF'])=="nouveau_ne.php")?"active":"";?>" href="nouveau_ne.php"><i class="fas fa-baby"></i>&nbsp;Nouveau-né</a>
                </li> 
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link <?=(basename($_SERVER['PHP_SELF'])=="defunt.php")?"active":"";?>" href="defunt.php"><i class="fas fa-user-slash"></i>&nbsp;Défunt</a>
                </li> 
                <li class="nav-item">
                    <a class="nav-link <?=(basename($_SERVER['PHP_SELF'])=="acte_deces.php")?"active":"";?>" href="acte_deces.php"><i class="fas fa-user-slash"></i><i class="fas fa-user-slash"></i>&nbsp;Décès</a>
                </li> 
