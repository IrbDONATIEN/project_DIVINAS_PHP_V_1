<?php
  require_once 'sessionOfficier.php';
  ...
  if(isset($_POST['action'])&& $_POST['action']=='displayAllMariages'){
        $output='';
        $data=$cOfficier->fetchAllActeMariageTous($communeId);
        $path='assets/php/';
...
if(isset($_POST['detail_mariage_id'])){
    ...
    $data=$cOfficier->fetchActeMariageDetailsByID($id);
...
if(isset($_POST['action'])&& $_POST['action']=='displayAllNaissances'){
        ...
        $actenaissance=$cOfficier->fetchAllActeNaissanceTous($communeId);
...
if(isset($_POST['action'])&& $_POST['action']=='displayAllActeDeces'){
    $output='';
        ...
        $acteDeces=$cOfficier->fetchAllActeDeceTous($communeId);
